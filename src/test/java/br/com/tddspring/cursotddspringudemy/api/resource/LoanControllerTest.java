...
import br.com.tddspring.cursotddspringudemy.api.service.LoanServiceTest;
...
public class LoanControllerTest {
	...
	public void createLoanTest() throws Exception {
		...
		LoanDTO dto = LoanDTO.builder().isbn("123").email("fulano@email.com").customer("Fulano").build();
		String json = new ObjectMapper().writeValueAsString(dto);

		Book book = Book.builder().id(1).isbn("123").build();
		BDDMockito.given(bookService.getBookByIsbn("123")).willReturn(Optional.of(book));

		Loan loan = Loan.builder().id(1).customer("Fulano").book(book).loanDate(LocalDate.now()).build();
	...
	@Test
	@DisplayName("Deve retornar erro ao tentar fazer emprestimo de livro inxistente")
	...
	public void returnBookTest() throws Exception {
		...
		BDDMockito.given(loanService.getById(Mockito.anyInt())).willReturn(Optional.of(loan));
	...
	public void returnInexistentBookTest() throws Exception {
		...
		BDDMockito.given(loanService.getById(Mockito.anyInt())).willReturn(Optional.empty());
